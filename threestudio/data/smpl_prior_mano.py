...
from ..utils.smpl.smpl_prompt_mano import SMPLPrompt
...
class RandomSMPLPriorCameraDataModuleConfig(RandomCameraDataModuleConfig):
    ...
    mano_root: str = ''
    model_type: str = 'mano_flat' #default is [mano, mano_flat]
    mesh_scaling_factor: float = 10.0 #default is 10, mano_flat is 9
...
class RandomSMPLPriorCameraIterableDataset(RandomCameraIterableDataset):
    def __init__(self, cfg: Any) -> None:
        ...
        self.smpl_prompt = SMPLPrompt(
            ...
            mesh_scaling_factor=cfg.mesh_scaling_factor,
            mano_root=self.cfg.mano_root
        )
        threestudio.info("SMPL MANO prompt initialized.")
    ...
    def collate(self, batch) -> Dict[str, Any]:
        ...
        smpl_conds_rgb, smpl_conds_depth = self.smpl_prompt(intrinsics[0], camera_poses)
        smpl_conds = [smpl_conds_rgb[0], smpl_conds_depth[0], smpl_conds_rgb[1]] #[mesh, depth, pose]
...
@register("mano-prior-camera-datamodule")
